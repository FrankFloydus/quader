...
AppServices::AppServices()
    ...
    , editor_actions(actions, document_ui, tool_manager, action_state_updater, notifications)
    , ui_context{
          actions,
...
Application::Application(QApplication& qt_app, ApplicationConfig config)
    : qt_app_(qt_app)
    , config_(std::move(config))
{
    ...
    const ui::FusionStylePolicy fusion_style;
    (void)fusion_style.apply(qt_app_);
