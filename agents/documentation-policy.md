...
copyright headers, and the `quader-docs-mantainer` workflow.
...
`quader-docs-mantainer` is a documentation-only freelancer agent. It does not go
through normal architect-intake workflow for documentation-only work.
